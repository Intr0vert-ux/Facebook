...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between items-center max-w-7xl p-3 mx-auto">
      ...
      >
        ...
        <div className="flex items-center bg-gray-100 px-3 py-2 rounded-full hover:bg-gray-200 transition-colors duration-200">
          ...
          <input
            ...
            type="text"
            className="border-0 md:block hidden outline-none bg-transparent text-sm placeholder-gray-500 w-40"
      ...
      <ul className="md:flex xl:gap-6 lg:gap-3 hidden list-unstyled text-gray-800">
